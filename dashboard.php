...
<head>
  ...
  <title>Ayo NgeBlog - Dashboard</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <?php 
              $result=mysqli_query($connection, "SELECT count(*) as total from artikel");
              $data=mysqli_fetch_assoc($result);
              $hasil_artikel = $data['total'];

              $result2=mysqli_query($connection, "SELECT count(*) as total from respon");
              $data2=mysqli_fetch_assoc($result2);
              $hasil_respon = $data2['total'];

              $result3=mysqli_query($connection, "SELECT count(*) as total from user");
              $data3=mysqli_fetch_assoc($result3);
              $hasil_user = $data3['total'];
             ?>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $hasil_artikel; ?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $hasil_respon; ?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $hasil_user; ?></div>
                        </div>
                      </div>
                    </div>
                    <div class="col-auto">
