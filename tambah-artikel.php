...
<head>
  ...
  <title>Ayo NgeBlog - Tambah Artikel</title>
            ...
            <div class="col-md-12">
              <form class="form" action="" method="POST">
                <div class="form-group">
                  <input type="text" name="judul" class="form-control" placeholder="Judul artikel" value="">
                </div>
                <div class="form-group">
                  <textarea name="isi" class="form-control" rows="20" placeholder="Tuliskan apa yang anda pikirkan"></textarea>
                </div>
                <div class="form-group">
                  <input type="hidden" name="penulis" value="<?php echo $_SESSION['username'] ?>"/>
                    ...
                    <a href="dashboard_artikel.php" class="btn btn-danger">Cancel</a>
                </div>
              </form>
            </div>
...
<?php 
  if(isset($_POST['simpan'])){
      $judul = empty($_POST['judul']) ? "Tanpa judul": $_POST['judul'];
      $isi = $_POST['isi'];
      $penulis = $_POST['penulis'];

      // lakukan penyimpanan ke database
      $simpan = mysqli_query($connection, "INSERT INTO artikel (judul,isi,penulis) VALUES('$judul','$isi','$penulis')");
